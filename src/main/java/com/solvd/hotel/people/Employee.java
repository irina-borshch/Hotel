...
public class Employee extends Person implements IPersonInfo {
    ...
    public Employee(String name, String lastName, String workPosition, String phoneNumber, double salary, int workerID) {
        super(name, lastName);
    ...
    public String toString() {
        return getClass().getName() + "[name=" + getName() + ", lastName=" + getLastName() + ", workPosition="
                + getWorkPosition() + ", phoneNumber=" + getPhoneNumber() + ", salary=" + getSalary() + ", workerID="
                + getWorkerID() + "]";
    }
    @Override
    public int hashCode() {
